...
<body>
	...
	<section class="container" style="margin-top: 0px;">
		...
		<div class="form-bg">
			<sf:form id="login" action="/login" method="post"
				...
				<h2>Login</h2>
				<p><sf:input type="text" path="userName" placeholder="用户名" /></p>
	...
	<section class="about">
		...
		<p class="about-author">
			&copy; 2014&ndash;2015 <a href="http://www.lyweiye.com"
				target="_blank">中伟业控股(集团)有限公司</a>
			<!--   -
      		<a href="http://www.lyweiye.com/license" target="_blank">License</a>-->
			<br> Original Dev by <a href="" target="_blank">Liu Yingxian</a>
		</p>
	</section>
