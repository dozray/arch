...
<link type="text/css" rel="sytlesheet"
	href="../../static/css/layout-default.css" />
...
<script type="text/javascript"
	src="../../static/js/layout/jquery.layout.js"></script>
<script type="text/javascript"
	src="../../static/js/ztree/jquery.ztree.js"></script>
<script type="text/javascript">
...
<SCRIPT type="text/javascript">
		...
		callback: {
			beforeClick: function(treeId, treeNode) {
				...
				if (treeNode.isParent) {
					...
					cframe.attr("src",treeNode.file + ".html");
					return true;
				}
			}
		}
	...
	var tNodes =[
		...
		{id:5, pId:0, name:"客户化", open:false},
		{id:501, pId:5, name:"", file:"super/oneroot"},
	...
	$(document).ready(function(){
		var t = $("#tree");
		t = $.fn.zTree.init(t, setting, tNodes);
		cframe = $("#cframe");
		cframe.bind("load", loadReady);
		var tree = $.fn.zTree.getZTreeObj("tree");
		tree.selectNode(zTree.getNodeByParam("id", 101));

	});

	function loadReady() {
		var bodyH = cframe.contents().find("body").get(0).scrollHeight,
		htmlH = cframe.contents().find("html").get(0).scrollHeight,
